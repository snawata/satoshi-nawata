...
\centerline{\Large \bf Homework 7: Due at class on April 19}

 \vspace{.5cm}
\noindent 1. Show that the Euler characteristics is equal to
$$
...
\noindent 2. Show that the Euler characteristics of an odd-dimensional oriented closed manifold is zero.
 ...
 \vspace{.5cm}
\noindent 3. Find the integer-valued homology group $H_\ell(\Sigma_g;\bZ)$ of a Riemann surface $\Sigma_g$ of genus $g$.


 \vspace{.5cm}
\noindent 4. Find both the integer-valued $H_\ell(\bR P^2;\bZ)$ and the real-valued $H_\ell(\bR P^2;\bR)$ homology groups of $\bR P^2$. Does the Poincar\'e duality hold?
