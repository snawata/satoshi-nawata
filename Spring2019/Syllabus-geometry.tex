...
\begin{description}
\item{\bf Course name:} Differential geometry and topology in physics (PHYS130082.01)
\item{\bf Instructor:} Satoshi Nawata, Physics S422, Jiangwan \href{mailto:snawata@fudan.edu.cn}{snawata@fudan.edu.cn}
\item{\bf Teaching Assistant:} Hao Zhang, Physics 4th floor, Jiangwan \href{mailto:18210190008@fudan.edu.cn}{18210190008@fudan.edu.cn}
\item{\bf Hours:}  Friday 10:50 -- 12:30
\item{\bf Place:} HGX303
...
\item{\bf Grade evaluation:} Grade will be determined based on homework sets (80\%) given every week and the final test (20\%).
