...
\centerline{\Large \bf Homework 3: Due at class on Oct 9}


\section{Derivations}
\subsection{Energy-momentum tensor in complex coordinate}
Show (3.46) by performing the coordinate transformation.

\subsection{Two-point function}
Obtain (3.69) from (3.68).


\subsection{Virasoro algebra}
Derive the Virasoro algebra (3.110) from (3.109) by performing the contour integral.
