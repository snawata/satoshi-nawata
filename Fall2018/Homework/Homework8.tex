...
\centerline{\Large \bf Homework 8: Due at class on Nov 16}



\section{Derivation}
Derive (6.13),  (6.14) and (6.19) of the lecture note.
...
\bea\nonumber
\cZ& = \int \mathcal { D } \varphi \exp \left[ -  { S } ^ { * } - \wh g \int \frac { d ^ { 2 } x } { a ^ { 2-\Delta} } \cO ( x ) \right]\cr
& =Z ^ { * } \left[ 1 - \wh g \int \frac { d ^ { 2 } x } { a ^ { 2-\Delta } } \left\langle \cO ( x ) \right\rangle+ \frac { \wh g^2 } { 2 }  \int _ { \left| x _ { 1 } - x _ { 2 } \right| > a } \left\langle \cO \left( x _ { 1 } \right) \cO \left( x _ { 2 } \right) \right\rangle \frac { d ^ { 2 } x _ { 1 } } { a ^ { 2-\Delta } } \frac { d ^ { 2 } x _ { 2 } } { a ^ { 2-\Delta } } + \cdots \right]
\eea
...
\bea
&- \frac { \wh g^2 } { 2 }\mathbf { C } a ^ {- h } \int _ { a < \left| x _ { 1 } - x _ { 2 } \right| < a ( 1 + \d \lambda ) } \left\langle \cO  \left( x _ { 2 } \right) \right\rangle \frac { d ^ { 2 } x _ { 1 } } { a ^ { 2-\Delta } } \frac { d ^ { 2 } x _ { 2 } } { a ^ { 2-\Delta}  }\cr
=&- \pi \d \lambda\,\wh g^2  \mathbf { C }   \int \left\langle \cO  ( x ) \right\rangle \frac { d ^ { 2 } x } { a ^ { 2-\Delta } }
\eea
Therefore, the total effect on the coupling constant under the infinitesimal scaling is
$$
\wh g  \rightarrow \wh g  + (2-\Delta) \wh g  \d \lambda - \pi  \mathbf { C }\wh  g^2  \d \lambda +\cO(\wh g^3)
$$
Consequently, we have the one-loop contribution to the $\beta$ function
$$
\frac { d \wh g  } { d \lambda } \equiv \beta  ( \wh g ) = (2-\Delta) \wh g  - \pi  \mathbf { C } \wh g^2 +\cO(\wh g^3)
$$
...
$$
\frac { d \wh   g } { d \lambda } =   -\pi\bfC   \wh g ^ { 2 } 
$$
