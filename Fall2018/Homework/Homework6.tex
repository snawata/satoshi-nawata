...
\centerline{\Large \bf Homework 6: Due at class on Nov 2}



\section{Fusion rule}
Following (5.36) of the lecture note, find the explicit fusion rule of the product
$$
\phi_{1,3}\times \phi_{2,2}
$$


\section{Descendant of the identity operator}
