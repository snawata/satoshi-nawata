...
\centerline{\Large \bf Homework 13: Due at class on Dec 21}

\section{Derivations}
\subsection{}
Derive (9.54). 
\subsection{}
Derive (9.59) from (9.57) by the coordinate transformation (9.58).
\subsection{}
Derive all the steps in (9.63).
\section{Killing vectors in AdS3}
Killing vector fields are the infinitesimal generators of isometries of a Riemannian manifold. In terms of the global AdS${}_3$ coordinate
$$d s ^ { 2 } = R ^ { 2 } \left( - \cosh ^ { 2 } \rho d t ^ { 2 } + d \rho ^ { 2 } + \sinh ^ { 2 } \rho d \phi ^ { 2 } \right)~,$$
they can be written as
$$
\begin{aligned} \zeta _ { - 1 } & = \frac { 1 } { 2 } \left[ \tanh ( \rho ) e ^ { - i ( t + \phi ) } \partial _ { t } + \operatorname { coth } ( \rho ) e ^ { - i ( t + \phi ) } \partial _ { \phi } + i e ^ { - i ( t + \phi ) } \partial _ { \rho } \right] \\ \zeta _ { 0 } & = \frac { 1 } { 2 } \left( \partial _ { t } + \partial _ { \phi } \right) \\ \zeta _ { 1 } & = \frac { 1 } { 2 } \left[ \tanh ( \rho ) e ^ { i ( t + \phi ) } \partial _ { t } + \operatorname { coth } ( \rho ) e ^ { i ( t + \phi ) } \partial _ { \phi } - i e ^ { i ( t + \phi ) } \partial _ { \rho } \right] \end{aligned}~.
$$%
Find the commutation relation $[\zeta_i,\zeta_j]$ and the corresponding Lie algebra.
