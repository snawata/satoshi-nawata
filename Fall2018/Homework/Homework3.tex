...
\centerline{\Large \bf Homework 3: Due at class on Oct 12}


\section{Derivations}
\subsection{Energy-momentum tensor in complex coordinate}
Show (3.50), (3.51), (3.52) by performing the coordinate transformation.
\subsection{Schwarzian derivative}
Derive the infinitesimal transformation (3.92) from the finite version (3.93).
\subsection{Virasoro algebra}
Derive the Virasoro algebra (3.116) from (3.115) by performing the contour integral.
...
Compute $TT$ OPE (4.49) in the free fermion.

\section{Vertex operator and OPE}
Show that $:e^{ik\varphi}:$ is a primary field of weight $h = \bar h = k^2/2$ in the free boson theory. In addition, show that $\partial^n \varphi$ ($n\ge 2$) is not a primary field.
...
In the lecture note (3.93), we have learned that,  under the conformal transformation
