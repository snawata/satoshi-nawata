...
\begin{description}
\item{\bf Course name:} PHYS130021.01: Introduction to 2d conformal field theories
\item{\bf Instructor:} Satoshi Nawata, Runkai Tao (TA)\\   Physics S422, Jiangwan campus,  \href{mailto:snawata@fudan.edu.cn}{snawata@fudan.edu.cn}
\item{\bf Hours:} Friday 9:55-12:30
\item{\bf Place:} HGX310
\item{\bf Office hour:}  By appointment. Any time, but email me beforehand. 
...
\item Correlation and partition functions
\item Some explicit models like minimal (Ising) models, etc
\item Advanced topics
\end{itemize}



\item{\bf Main references:} I will use combinations of these references.
