...
\centerline{\Large \bf Homework 5: Due at class on April 7}

 \vspace{.5cm}
\noindent 1. Let $T^2=S^1\times S^1$ be the torus. Using the formula for de Rham cohomology  of a product space,
$$
H_{dR}^{p+q}(M\times N)\cong H_{dR}^p(M)\otimes H_{dR}^q(N)~,
$$
...
\vspace{.5cm}
\noindent 3. Derive the expression of the Christoffel symbols
$$
...
$$
R^l{}_{ijk}=\Gamma_{jk}^s\Gamma_{is}^l\;-\;\Gamma_{ik}^s\Gamma_{js}^l\;+\;\frac{\partial\Gamma_{jk}^l}{\partial{x}^i}\;-\;\frac{\partial\Gamma_{ik}^l}{\partial{x}^j}.
$$
...
\vspace{.5cm}
\noindent 4. Let $S^2 \subset \bR^3$ be the 2-sphere with unit radius and the metric on $S^2$ is induced from the standard metric of $\bR^3$ as in Homework 4. Find geodesics on $S^2$ and compute its Riemann, Ricci and scalar curvature.
...
\vspace{.5cm}
\noindent 5.  Let $\mathbf{H}=\{(x,y)|y>0\}$ be the upper half plane and the metric is given by
