...
$$
where $\kappa$ is called the Gauss curvature. The Gauss-Bonnet theorem was later generalized to the celebrated Hirzebruch-Riemann-Roch theorem and index theorem, which can be regarded as one of the milestones in mathematics of the twentieth century. The motto of these theorems is ``from local to global''. We will glimpse these theorems in \S\ref{sec:index-thm}.

The geometric study of surfaces was preceded by Gauss, which indicates the geometry beyond Euclid. In the middle of the 19th century, Riemann proposed a concept of manifolds of arbitrary dimensions \cite{riemann1854hypothesen}. Furthermore, he clearly envisioned \textbf{Riemannian geometry} which deals with metrics, connections and curvatures on a manifold. Remarkably, his idea on ``holomorphic function on a Riemann surface'' \cite{riemann1857theorie} also has later led to the theory of \textbf{complex geometry} and \textbf{algebraic geometry}. Around 1900, Poincar\'e has opened up a new area of mathematics, nowadays called \textbf{algebraic topology} \cite{poincare1895analysis}. He has illustrated his idea of studying topology by homology groups and fundamental groups.

The large part of the ideas of Riemann and Poincar\'e is not furnished with mathematical rigorous techniques of their time, so the necessary tools had to be invented. As a result, their revolutionary ideas and methods are to be a source of inspiration for a century, and the later development justified their intuitions.\footnote{For a history of algebraic and differential topology, we refer to \cite{dieudonne2009history}.} One can see similar phenomena in the current relation between physics and mathematics.
...
It turns out that these notions are indispensable to a description of physics. Hamilton's formulation \cite{hamilton1834general} of classical mechanics is the birth of symplectic geometry. Maxwell's equation \cite{maxwell1865viii} is described by differential forms. We need to learn Riemannian geometry for Einstein's equations \cite{einstein1915feldgleichungen}.  Yang-Mills theory \cite{yang1954conservation} is constructed based on the theory of vector bundles. The non-perturbative effects in quantum field theories are often formulated in terms of characteristic classes. Supersymmetry and quantum anomaly require the index theorem.



\subsection{Disclaimer, textbooks and references}

In this course, we will omit proofs of theorems, delegating them to the mathematical literature. We rather learn the meanings of theorems and how to use them. Moreover,
we will learn how geometric and topological methods are indispensable in physics through examples and homework sets.


There are many textbooks and you can pick what suits you best.  However, I do not recommend you to stick only to one book, and it is often illuminating to compare books since they are written from different perspectives. (Don't try to read through all the books because it's impossible. What's important is not reading all the books, but understanding the subject.) For basics of differential geometry, one can refer to \cite{singer1967lecture,spivak1970comprehensive,kobayashi1963foundations,morita2001geometry,warner2013foundations,bott1982differential}. There are many books \cite{arnol1974mathematical,frankel2011geometry,nash1988topology,nakahara2003geometry} that explain the connections to physics. It should be noted that Milnor's books \cite{milnor1965topology,milnor1963morse} would be wonderful-read.


\subsection{Localization and toy model of TQFT}\label{TQFT}
...
\rho \chi=-\chi \rho~.
$$
The integration rules of Grassmann variables are given by
$$
...
$$
We again take $W\to tW$ and the partition function is localized at critical point of $W$ as $t\to \infty$
\bea
