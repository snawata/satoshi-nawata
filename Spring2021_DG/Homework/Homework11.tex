...
\centerline{\Large \bf Homework 11: Due at class on May 23}
...
$$
is anti-self-dual. Furthermore, one can change the position $x_0$ of instanton by
$$
A_{\lambda,x_0}(x)=\Im \left\{  \frac{\overline{(x-x_0)}dx}{\lambda^2+|x-x_0|^2}\right\}~.
$$
The 5 parameters $(\lambda,x_0)$ (size and position) are called \textbf{moduli of instanton}.
...
Show that the equations of motion for this action becomes
\begin{align}\label{YMH}
&\ast d_A \ast F+[\Phi,D_A\Phi]=0\cr
& \ast d_A \ast D_A\Phi=0~.\nonumber
\end{align}
If field configurations $(A,\Phi)$ satisfy
$$
\ast F=\pm D_A\Phi~,
$$
which is called \textbf{Bogomol'nyi equation or non-Abelian monopole equation}, then show that $(A,\Phi)$ obeys the equations of motion.
