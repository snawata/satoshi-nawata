...
\centerline{\Large \bf Homework 1: Due at class on Sep 22}


\section{}
If an action is Weyl invariant, then show (without relying on an explicit form of action) that its stress-energy tensor is traceless.
