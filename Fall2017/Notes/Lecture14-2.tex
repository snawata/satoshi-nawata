...
\begin{itemize}
 ...
 \item it also contains vectors living on the D-branes, which arises from an open string massless spectrum,
...
Typical example is a cross of NS$5$ and D$5$ create/annihilate D$3$-brane (see Fig.).
\begin{figure}[htb]
