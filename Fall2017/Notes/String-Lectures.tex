...
\title{Introduction to string theory: Fall-2017}
...
\abstract{
These are lecture notes of the course on string theory at Fudan in Fall 2017. Each section is written for a lecture for about 2.5 hours. Comments are welcome. If you find typos, please let us know.
}
...
\subsubsection{Why do we study string theory?}
...
\subsubsection{Very very brief history}
...
\subsubsection{Very short highlights}
...
\begin{figure}[htb]
 \centerline{\includegraphics[width=250pt]{fig1}}
...
\subsection{Conformal field theory in 2d}
...
\subsubsection{Massless scalar theory in 2d}
...
\subsubsection{Operator analysis (Path integral quantization)}
...
\subsubsection{Operator product expansion (OPE)}
...
\subsubsection{Noether's theorem and Ward-Takahashi identities}\label{sec:Noether}
...
\subsubsection{Weyl anomaly from curved WS}
...
\subsubsection{Non-linear sigma model (Graviton included)}
...
\subsubsection{Perturbation theory for NLSM (Weyl anomaly from curved ST)}
...
\subsection{Type II string theories}


\subsubsection*{Physical spectrum and the GSO Projection}
...
\subsubsection*{Type II Superstrings}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=350pt]{OpenClosed.eps}}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=100pt]{BoundaryObj.eps}}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=250pt]{ManyD.eps}}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=350pt]{MagD.eps}}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=250pt]{EleMagD.eps}}
...
\subsubsection{Torus and its modulus \& CKG}
...
\subsection{Type I superstring theory}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=350pt]{KleinBottle.eps}}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=300pt]{MobiusStrip.eps}}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=100pt]{type1dual.eps}}
...
\begin{figure}[htb]
\centerline{\includegraphics[width=200pt]{tangent.eps}}
...
\subsubsection{10d Type IIA SUGRA}
...
\subsubsection{10d Type IIB SUGRA}
...
\subsubsection{S-duality of Type IIB SUGRA}
...
\subsubsection{Branes, Strings ending on Branes}
...
\subsubsection{Bound states of D-branes}
...
The wave equation in the AdS$_{d+1}$ space in Euclidean signature for  a field of mass $m$ has
...
the boundary condition on the field on the right-hand side of \eqref{GKPW} should in general be changed to
\be\label{bcond}
\phi(\vec x , \epsilon) = \epsilon^{d - \Delta } \phi_0(\vec x),
\ee
and we would eventually take the limit where $\epsilon \to 0$.
Since $\phi$ is dimensionless, we see that $\phi_0$ has dimensions
of $[\textrm{length}]^{\Delta - d}$ which implies, through the left-hand side of  \eqref{GKPW}, that the associated operator ${\cal  O}$
has dimension $\Delta$ \eqref{dimenmass}.
...
\be
\nabla^2_{\textrm{AdS}_5}\,\phi_l\,=\,m_l^2\,\phi_l\,\,,
\qquad\qquad
m_l^2=\frac{l(l+4)}{ R^2}\,\,.
\label{KK_masses}
\ee
